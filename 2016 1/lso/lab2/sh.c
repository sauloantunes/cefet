...
/* MARK NAME Saulo Antunes Silva */

/*
Conteúdo: Shell. Dica: veja função int dup2(int oldfd, int newfd); 
Ver problema descrito em 
http://homepages.dcc.ufmg.br/~cunha/teaching/20132/os/tp0a.html 
Procure soluções genéricas: 
não simplesmente reimplemente alguns comandos
*/
